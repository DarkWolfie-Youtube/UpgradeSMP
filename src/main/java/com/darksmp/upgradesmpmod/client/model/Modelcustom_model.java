package com.darksmp.upgradesmpmod.client.model;
...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("upgradesmpmod", "modelcustom_model"), "main");
