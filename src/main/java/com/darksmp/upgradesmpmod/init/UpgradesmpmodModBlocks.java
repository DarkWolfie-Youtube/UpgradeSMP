...
import com.darksmp.upgradesmpmod.block.LemonSaplingOldBlock;
...
public class UpgradesmpmodModBlocks {
	...
	public static Block LEMON_SAPLING_OLD;
	...
	public static void load() {
		...
		LEMON_SAPLING_OLD = Registry.register(Registry.BLOCK, new ResourceLocation(UpgradesmpmodMod.MODID, "lemon_sapling_old"), new LemonSaplingOldBlock());
	}
	...
	public static void clientLoad() {
		...
		LemonSaplingOldBlock.clientInit();
	}
}
